...
function CustomizeProfilePersonal({ navigation, route, session }) {
            ...
            if (user) {
                try {
                    ...
                    if (personalError) {
                        ...
                        console.error("Error inserting into personal_users:", personalError.message);
                        return;
                    }
    ...
    return (
        ...
        >
            <ScrollView style={{ flex: 1, backgroundColor: appStyles.colors.background }}>
                <View
                    style={{
                        flex: 1,
                    ...
                    <View>
                        <TouchableOpacity style={{ alignItems: 'center', marginTop: 20 }} onPress={pickImage}>
                            {image ? <Image source={{ uri: image }} style={{ width: 100, height: 100 }} /> :
                                <Image source={require('../images/profilePic_placeholder.png')} style={{ width: 100, height: 100 }} />}
                            <Text
                                style={[
