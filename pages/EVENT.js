    ...
    <View style={styles.container}>
      ...
      <View style={styles.detailsContainer}>
        ...
        <View style={styles.toggleContainer}>
          <Card width="225" borderRadius={12} style={[styles.shadow, styles.card]}><Text style={{ fontFamily: "IBMPlexSans-Medium " }}>{event.description}</Text></Card>
        ...
        <TouchableOpacity onPress={handleBookmarkToggle} style={styles.bookmarkButton}>
          <View style={styles.bookmarkBox}>
            <Ionicon name={isBookmarked ? 'bookmark' : 'bookmark-o'} size={25} color='#FFC60A' />
          </View>
        </TouchableOpacity>
        {/* toggle attending button if isAttending true or false */}
        <TouchableOpacity onPress={handleAttendToggle} style={styles.attendButton}>
          <Text style={styles.attendButtonText}>{event.isAttending ? 'Attending' : 'Attend'}</Text>
        </TouchableOpacity>
      </View>
      ...
      <Modal isVisible={isModalVisible} onBackdropPress={toggleModal} style={styles.modal}>
        <View style={styles.modalContainer}>
          ...
          <Text style={styles.modalAlert}>Your safety is important to us. Our team works hard to monitor any suspicious behavior on our app. Please submit this report if an event is seen to be suspicious or unreliable. Your report will remain anonymous.</Text>
          <View style={styles.modalOptionsContainer}>
            <TouchableOpacity onPress={toggleModal} style={[styles.modalOption, styles.modalOption1]}>
              <Text style={styles.modalOptionText}>Cancel</Text>
            </TouchableOpacity>
            <TouchableOpacity onPress={toggleModal} style={[styles.modalOption, styles.modalOption2]}>
